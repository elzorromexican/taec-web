...
assert(
  !clientesHtml.includes("18 años construyendo el futuro del aprendizaje corporativo"),
  "Expected /clientes not to contain the main /nosotros heading"
);
assert(
  nosotrosHtml.includes("18 años construyendo el futuro del aprendizaje corporativo"),
