...
describe('calcularDiagnostico', () => {
  ...
  const mockQuestions: WeightedQuestion[] = [
    { id: 'q1', text: '', why: '', weight: 3, painAxis: 'tecnologia', plat: 'lms_agil', insight: { none: '', mild: '', urgent: '' } },
    { id: 'q2', text: '', why: '', weight: 3, painAxis: 'contenido', plat: 'fabrica_ddc', insight: { none: '', mild: '', urgent: '' } },
    { id: 'q__null', text: '', why: '', weight: 1, painAxis: 'admin', plat: null, insight: { none: '', mild: '', urgent: '' } },
  ];
  ...
  test('T3: plat:null no contamina platform scores', () => {
    ...
    let platSum = 0;
    Object.values(res.platformScores).forEach(val => platSum += (val as number));
  ...
  test('T4: Normalization platform scores', () => {
    ...
    const qA: WeightedQuestion[] = [
      { id: 'c1', text: '', why: '', weight: 1, painAxis: 'admin', plat: 'lms_corp', insight: { none: '', mild: '', urgent: '' } },
      { id: 'c2', text: '', why: '', weight: 1, painAxis: 'admin', plat: 'lms_corp', insight: { none: '', mild: '', urgent: '' } },
      { id: 'c3', text: '', why: '', weight: 1, painAxis: 'admin', plat: 'lms_corp', insight: { none: '', mild: '', urgent: '' } },
      { id: 'a1', text: '', why: '', weight: 1, painAxis: 'tecnologia', plat: 'lms_agil', insight: { none: '', mild: '', urgent: '' } }
    ];
    const answers: DiagnosticAnswers = {
      stage: 'corporativa',
  ...
  test('T5: winningPlatform tiebreak', () => {
    ...
    const qTie: WeightedQuestion[] = [
      { id: 't1', text: '', why: '', weight: 1, painAxis: 'admin', plat: 'lms_corp', insight: { none: '', mild: '', urgent: '' } },
      { id: 't2', text: '', why: '', weight: 1, painAxis: 'admin', plat: 'eval_proctor', insight: { none: '', mild: '', urgent: '' } },
    ];
    const answers: DiagnosticAnswers = { stage: 'corporativa', answers: { 't1': 2, 't2': 2 } };
  ...
  test('T6: topPains ordenados correctamente', () => {
    ...
    const qPains: WeightedQuestion[] = [
      ...
      { id: 'p1', text: '', why: '', weight: 1, painAxis: 'tecnologia', plat: 'lms_agil', insight: { none: '', mild: '', urgent: '' } },
      // contenido: score 100% (raw 6/ max 6), weight 3 -> avg w 3
      { id: 'p2', text: '', why: '', weight: 3, painAxis: 'contenido', plat: 'lms_agil', insight: { none: '', mild: '', urgent: '' } },
      // admin: score 50%
      { id: 'p3', text: '', why: '', weight: 2, painAxis: 'admin', plat: 'lms_agil', insight: { none: '', mild: '', urgent: '' } },
    ];
    const answers: DiagnosticAnswers = { stage: 'corporativa', answers: { 'p1': 2, 'p2': 2, 'p3': 1 } };
