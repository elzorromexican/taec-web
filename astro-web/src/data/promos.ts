...
export const promos: PromoConfig[] = [
	...
	},
	{
		...
		description:
			"Renueva o adquiere licencias de Articulate 360 al tipo de cambio preferencial con soporte local en español gratuito.",
	...
	},
	{
		...
		description:
			"Nuestra fábrica de desarrollo de contenidos a medida atiende proyectos en cualquier idioma. ¡Delega la producción!",
	...
	},
	{
		...
		description:
			"Co-organizado por TAEC y Articulate. Aforo limitado · Confirmación personalizada.",
		badgeText: "🎯 EVENTO",
