...
export type PlatformId =
  | 'lms_agil' | 'lms_corp' | 'lms_cert'
  | 'fabrica_ddc' | 'tools_autor' | 'vilt_zoom'
  | 'eval_proctor' | 'ecommerce';
...
export const stages: DiagnosticStage[] = [
  {
    ...
    description: 'Empresas con menos de 100 usuarios, que no tienen un LMS formal o recién inician su camino en e-learning corporativo.',
    ...
    questions: [
      {
        ...
        painAxis: 'tecnologia',
        plat: 'lms_agil',
        insight: { none: 'Operación estabilizada en este rubro.', mild: 'Alerta temprana. Si continúa creciendo, la fricción aquí se convertirá en un cuello de botella o riesgo regulatorio.', urgent: 'Falla crítica detectada. Este dolor te está costando dinero, tiempo clave del management o exponiendo a multas.' }
      },
      {
  ...
  },
  {
    ...
    description: 'Empresas con 100 a 5,000 usuarios, con LMS activo o en evaluación, y requerimientos de cumplimiento normativo.',
    examples: '100-5,000 usuarios · LMS activo o en evaluación · cumplimiento normativo',
    questions: [
      {
  ...
  },
  {
    ...
    description: 'Empresas con LMS estable que buscan certificar a terceros, monetizar contenidos, o administrar múltiples entidades formativas autónomas.',
