...
export const mainNav: MainNavItem[] = [
	{
		...
		columns: [
				...
				items: [
					{
						label: "Moodle",
						url: "/moodle-mexico",
						badge: { text: "SaaS", type: "saas" },
					},
					{
						label: "Totara",
						url: "/totara-lms-mexico",
						badge: { text: "SaaS", type: "saas" },
					},
					{
						label: "Pifini Learn",
			...
			},
			{
				...
				items: [
					{
						label: "Desarrollo de Contenidos",
						url: "/desarrollo-de-contenidos",
						badge: { text: "DDC", type: "new" },
					},
