...
export const ddcHero = {
	...
	subtitle:
		"Tu Project Manager dedicado coordina cada fase —desde el análisis instruccional hasta la entrega de archivos editables— garantizando calidad, tiempos y total autonomía sobre tus contenidos.",
	features: [
...
export const ddcBeneficios = {
	...
	subtitle:
		"Más de 18 años produciendo cursos a medida para corporativos en México, LATAM, Europa y Estados Unidos.",
	columns: 3 as const,
	theme: "general" as const,
	cards: [
		{
			...
			description:
				"Desarrollamos con Articulate 360 (Storyline, Rise) y Vyond: la combinación más potente del mercado para cursos interactivos, animación 2D, Motion Graphic y video formativo.",
		},
		{
			icon: "🏆",
			title: "Metodología con garantía",
			description:
				"ADDIE para diseño instruccional + Agile SAM para producción multimedia. Garantía técnica de 6 meses sobre funcionalidad y publicación en cualquier LMS o LXP.",
		},
		{
			icon: "📂",
			title: "Transparencia y autonomía",
			description:
				"Siempre entregas los archivos fuente editables. Revisiones incluidas vía Articulate Review 360. Tú controlas tu contenido, sin dependencia del desarrollador.",
		},
	],
};
...
export const ddcFaqs = [
	{
		...
		answerHtml:
			"El precio se presenta como presupuesto <strong>por proyecto</strong>, una vez analizados los contenidos fuente y definidas las características del curso. También existe la modalidad <strong>por Hora Hombre</strong>, ideal para proyectos de alcance variable o desarrollo atípico. Incluimos descuentos por volumen y frecuencia.",
	},
	{
		question: "¿Necesito tener el contenido listo para cotizar?",
		answerHtml:
			"Para una cotización precisa necesitamos el <strong>contenido fuente final y validado</strong>. A partir de él estimamos duración, nivel de interactividad y costo real. Si el contenido está en borrador, podemos hacer una estimación preliminar en sesión; los ajustes se afinarán una vez validado. Si no cuentas con el contenido final, platiquemos sobre la duración esperada para estimar un costo.",
	},
	{
		question: "¿Cuánto tiempo toma producir un curso?",
		answerHtml:
			"Definimos <strong>planes de trabajo específicos</strong> según la disponibilidad de tu equipo revisor. Es posible producir varios cursos de forma <strong>simultánea y escalonada</strong>, liberando objetos de aprendizaje semanalmente para cumplir fechas de lanzamiento ajustadas.",
	},
	{
		question: "¿Qué estándares de eLearning soportan?",
		answerHtml:
			"Producimos bajo <strong>SCORM 1.2, SCORM 2004 y xAPI (Tin Can)</strong>. El paquete garantiza registro de avance, evaluaciones y seguimiento individual en cualquier LMS o LXP. Probamos funcionamiento en nuestra plataforma LMS antes de entregar.",
	},
	{
		question: "¿Me entregan los archivos editables del curso?",
		answerHtml:
			"<strong>Sí, siempre.</strong> Es una política de TAEC DDC. Recibirás los archivos fuente de Articulate (<code>.story</code> / <code>.rise</code>) y los archivos de Vyond, para que puedas actualizar el contenido de forma independiente, sin depender del desarrollador.",
	},
	{
		question: "¿Qué cubre la garantía de 6 meses?",
		answerHtml:
			"Cubre <strong>aspectos técnicos y funcionales</strong> relacionados con la construcción o publicación: reproducción en navegadores modernos, tracking SCORM, visualización responsive y compatibilidad con plataforma LMS. No cubre cambios de contenido solicitados después de aprobada la versión Gold.",
	},
	{
		question: "¿Pueden coordinar con el área de TI de mi empresa?",
		answerHtml:
			"Sí. Tenemos amplia experiencia coordinando con equipos de TI corporativos para implementación en plataformas internas, configuración de SCORM y pruebas de integración con el LMS del cliente. Respaldamos a tu equipo de L&D en todo el proceso.",
	},
];
...
export const ddcCta = {
	...
	subtitle:
		"Agendemos una sesión sin costo: te mostramos casos reales, resolvemos tus dudas y diseñamos una propuesta a medida para tu programa de formación.",
