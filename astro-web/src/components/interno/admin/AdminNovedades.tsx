				...
				<div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
					{novedades.map((nov) => (
						<div
							key={nov.id}
							style={{
								border: nov.activo ? "1px solid #cbd5e1" : "1px dashed #94a3b8",
								borderRadius: "8px",
								padding: "1rem",
								background: nov.activo ? "#ffffff" : "#f1f5f9",
							...
							<div style={{ display: "flex", justifyContent: "space-between" }}>
								<div>
									<span
										style={{
											...
											fontWeight: "bold",
											background:
												nov.badge_color === "orange" ? "#ffedd5" : "#dbeafe",
											color:
												nov.badge_color === "orange" ? "#c2410c" : "#1d4ed8",
											marginBottom: "8px",
										}}
									>
										{nov.badge_text}
									...
									<p
										style={{ margin: 0, fontSize: "0.9rem", color: "#475569" }}
									>
										{nov.fecha_display} | Orden: {nov.orden}
									</p>
								</div>
								<div
									style={{
								...
								>
									...
									<button
										...
										style={{
											background: nov.activo ? "#ef4444" : "var(--check-green)",
											color: "white",
											border: "none",
											padding: "4px 8px",
											borderRadius: "4px",
				...
				>
					...
					>
						...
						<div style={{ display: "flex", gap: "1rem" }}>
							<div style={{ flex: 1 }}>
								...
								<input
									required
									type="text"
									placeholder="Ej: 06 Abr 2026"
									value={formData.fecha_display || ""}
									onChange={(e) =>
										setFormData({ ...formData, fecha_display: e.target.value })
									}
									style={{
										width: "100%",
										padding: "8px",
						...
						<div className="wysiwyg-container">
							...
							>
								Contenido de la Novedad (Editor Visual)
							</label>
							<div
								style={{
									borderRadius: "6px",
