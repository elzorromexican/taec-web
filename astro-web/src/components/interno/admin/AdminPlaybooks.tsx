		...
		<div className="admin-tab-content">
			<div className="content-header" style={{ marginBottom: "1rem" }}>
				...
				<p style={{ color: "#64748b", fontSize: "0.9rem", margin: 0 }}>
					Modifica las características clave y el diseño de la cabecera (Hero)
					para los 22 productos B2B.
				</p>
			</div>
					...
					{playbooks.map((pb) => (
						...
						>
							<div>
								...
								>
									Familia: {pb.familia} | Ícono: {pb.svg_icon}
								</p>
							</div>
							<button
						...
						>
							<div style={{ display: "flex", gap: "1rem" }}>
								<div style={{ flex: 1 }}>
									...
									>
										Patrón de Fondo (Familia)
									</label>
									<select
										value={selectedPb.familia}
										onChange={(e) =>
											setSelectedPb({ ...selectedPb, familia: e.target.value })
										}
										style={{
											width: "100%",
											padding: "8px",
								...
								<div style={{ flex: 1 }}>
									...
									<select
										value={selectedPb.svg_icon}
										onChange={(e) =>
											setSelectedPb({ ...selectedPb, svg_icon: e.target.value })
										}
										style={{
											width: "100%",
											padding: "8px",
									...
									>
										<option value="clapperboard">
											Claqueta (Estudios/Videos)
										</option>
										<option value="smartphone">Móvil / Vertical</option>
										<option value="sparkles">
											Destellos (Inteligencia Artificial)
										</option>
										<option value="building">
											Edificio / Enterprise / Plataforma
										</option>
							...
							>
								...
								<div style={{ display: "flex", gap: "1rem" }}>
									<div style={{ flex: 1 }}>
										...
										<input
											type="text"
											value={selectedPb.meta_l1 || ""}
											onChange={(e) =>
												setSelectedPb({
													...selectedPb,
													meta_l1: e.target.value,
												})
											}
											style={{
												width: "100%",
									...
									<div style={{ flex: 2 }}>
										...
										<input
											type="text"
											value={selectedPb.meta_v1 || ""}
											onChange={(e) =>
												setSelectedPb({
													...selectedPb,
													meta_v1: e.target.value,
												})
											}
											style={{
												width: "100%",
							...
							>
								...
								<div style={{ display: "flex", gap: "1rem" }}>
									<div style={{ flex: 1 }}>
										...
										<input
											type="text"
											value={selectedPb.meta_l2 || ""}
											onChange={(e) =>
												setSelectedPb({
													...selectedPb,
													meta_l2: e.target.value,
												})
											}
											style={{
												width: "100%",
									...
									<div style={{ flex: 2 }}>
										...
										<input
											type="text"
											value={selectedPb.meta_v2 || ""}
											onChange={(e) =>
												setSelectedPb({
													...selectedPb,
													meta_v2: e.target.value,
												})
											}
											style={{
												width: "100%",
							...
							>
								...
								<div style={{ display: "flex", gap: "1rem" }}>
									<div style={{ flex: 1 }}>
										...
										<input
											type="text"
											value={selectedPb.meta_l3 || ""}
											onChange={(e) =>
												setSelectedPb({
													...selectedPb,
													meta_l3: e.target.value,
												})
											}
											style={{
												width: "100%",
									...
									<div style={{ flex: 2 }}>
										...
										<input
											type="text"
											value={selectedPb.meta_v3 || ""}
											onChange={(e) =>
												setSelectedPb({
													...selectedPb,
													meta_v3: e.target.value,
												})
											}
											style={{
												width: "100%",
