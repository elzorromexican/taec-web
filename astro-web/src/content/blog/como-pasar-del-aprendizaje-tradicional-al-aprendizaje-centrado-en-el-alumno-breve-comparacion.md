---
title: "Cómo pasar del aprendizaje tradicional al aprendizaje centrado en el alumno: BREVE COMPARACIÓN."
...
> 
> _John Dewey_ – pedagogo, psicólogo y filósofo estadounidense.
...
![](https://lh6.googleusercontent.com/o6GcaaoewZnjaupx9PUjg9QdsIHVYCTVLPFphFZeOPthw6FoJAfAxPOK_0xltYj1TIMjyHTA5u3EBZ1H2P-NTUzb428sJ_pyjBaZfaZyZ077v1JqyP7shqNEYDt0BrKtDeA4wyM=s1600)
...
_\-¿qué tan importante es renovar la edición de libros si de todas formas lo poco que cambia son preguntas que de hecho al poder ser cambiables, no son esenciales?”_

A esto el sistema tradicional responde:

_\-Si el niño no tiene acceso a las preguntas que queremos evaluar, entonces no tendrá la capacidad de tener éxito pues es en estos reactivos que se va a basar el gordo del contenido de la clase y la graduación de desempeño._
...
#### b. El propósito de las instituciones que utilizan el aprendizaje enfocado en el alumno es el descubrimiento del objeto de interés que fundamenta la motivación del alumno.

Como ya mencionamos la motivación es un factor complicado de implementar, imposible de coercer. Por eso es que un método de selección personal de interés es excelente para crear motivación frente a la educación que se aplica a todo. La atención del docente para introducir el conocimiento a partir del objeto de interés es esencial.
