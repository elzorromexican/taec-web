---
title: "MOOCs y APRENDIZAJE ADAPTATIVO EN E-LEARNING: la combinación perfecta"
...
En realidad el aprendizaje por medio de MOOCs existe desde antes de que el término existiera ya que algunas personas, creadores de sitios web de los años 90, ya habían subido cursos libres a la web 1.0 bajo el  formato de palabras e imágenes esencialmente, aún así estos eran cursos abiertos, masivos y en línea lo cual respondía ya a la definición de lo que es un MOOC (_Massive, Open, Online, Course_).
...
En la actualidad se está desencadenando la tecnología del aprendizaje adaptativo en un entorno virtual. Gracias a tecnología actual como es el _big data_, el _machine learning_ y el _deep learning_ podemos, y debemos superar las barreras que los creadores de MOOCs antiguos no podían solventar. Estas son: la interacción con el usuario, la personalización del curso para cada usuario y el intercambio por ósmosis al socializar con otros alumnos de manera efectiva.
...
La tecnología _big data_ complementada con la tecnología de _machine learning_ permite lograr la personalización adecuada al permitir que la computadora entienda las carencias que necesitan los alumnos que al ejercerse en las actividades dadas por el programa alimentan a este con datos y así el sistema puede ir personalizando el aprendizaje.
...
Es en este sentido que la tecnología _big data_ y el _machine learning_ personalizan el aprendizaje. 

Con la tecnología aún más avanzada del _deep learning_ podemos hacer que las computadoras literalmente diseñen cursos o metodologías de aprendizaje innovadoras. 
...
IBM consideró ya en 2013 que la ciencia cognitiva junto, el _big data_, el _machine learning_ y el _deep learning_ iban a ser los 4 elementos que iban a revolucionar a la educación.
...
La primera parte de la pregunta es: ¿Cómo cada quien puede aprender de manera personalizada? Estamos tentados de responder que el aprendizaje adaptativo fundamentado en tecnología de punta (_big data_/ _machine learning_/ _deep learning_) nos va a dar finalmente la capacidad de rellenar esta carencia de la educación actual: darle a cada alumno una formación super especializada.
