...
| IA | Rol |
|----|-----|
| **Antigravity** (Google) | Responsable del código — implementa todo |
| **Claude Code** (este) | QA, auditoría, specs técnicas, consejos. NO escribe código directamente |
| **ChatGPT** | PM y arquitecto |
